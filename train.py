...
BATCH_SIZE = 16 
TRAIN_DF_DIR = './dataset/mnist_train.csv'
TEST_DF_DIR = './dataset/mnist_test.csv'
...
train_dataloader, val_dataloader, test_dataloader = get_loaders(train_df_dir=TRAIN_DF_DIR,
                                                                test_df_dir=TEST_DF_DIR,
